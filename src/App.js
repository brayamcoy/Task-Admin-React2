...
function App() {
  ...
  // setTypes(["Grass", "Poison", "Fire", "Water", "Flying", "Bug", "Normal", "Veneno"]);
  const [pokemons] = useState([
    ...
    },
    {
      ...
      type: ["Fire", "Flying"],
      sprite:
        "https://vignette.wikia.nocookie.net/es.pokemon/images/7/74/Charizard_XY.gif/revision/latest?cb=20140807015236",
      base: {
        HP: 78,
        Attack: 84,
        Defense: 78,
  ...
  return (
    <div className="container">
      ...
      <div className="filters">
        <form className="search-container" onChange={handleFilter}>
